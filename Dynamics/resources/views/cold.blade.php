          ...
          <div class="carousel-item active">
            ...
            <div class="container">
              <div class="carousel-caption text-left">
                ...
                <p style = "color: #121212" data-animation="animated zoomInRight" >Système de climatisation, matériel de climatisation Bifm-Tech vous offre l'expertise et la qualité dans son service et vos besoins.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-10">
                <div class="section-title text-center pb-30">
                    <h3 class="title" style="font-size: 29px">UN SERVICE COMPLET COMPRENANT :</h3>
